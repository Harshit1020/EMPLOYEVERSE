...
const EmployeLayout = ({ children }) => {
  ...
  const {erorrs} = useSelector((state) => (state.employeReducer))
...
if(erorrs){
  ...
  return (  
    <>
      ...
      <Link className="no-underline header_elems" href={ isAuthenticated ? "/employe/auth" : "/employe"}>Home</Link>
       ...
       {isAuthenticated ? <>
      <Link className='me-4 text-black no-underline'  href="/employe/auth/profile">Profile</Link>
      <Link className='me-4 text-black no-underline'  href="/employe/auth/applied">My Application</Link>
    ...
    <Link className='me-4 text-black no-underline'  href="/">Main Page</Link>
     <Link className='bg-transparent me-4 no-underline hover:bg-blue-500 text-blue-700 font-semibold hover:text-black py-2 px-4 border border-blue-500 hover:border-transparent rounded text-link-none' href="/employe/signin">Signin</Link>
      <Link className='bg-blue-500 no-underline hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full' href="/employe/signup">Signup</Link>
    </>
    }
    </div>
    </div>
